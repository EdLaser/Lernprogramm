...
Quiz.prototype.render = function(container) {
    ...
    document.getElementById('#submit-button').click(function() {
        ...
        document.getElementById('#quiz-results-message').text(message);
        document.getElementById('#quiz-results-score').html('You got <b>' + score + '/' + self.questions.length + '</b> questions correct.');
